...
int main(){
	...
	uint8_t cmd_hdr1 = (PART_ID_16 << 4) & 0xFF00 ; // on obtient l'octet msb
	uint8_t cmd_hdr2 = ((PART_ID_16 << 4) & 0x00FF) | 0x08; // on indique quon souhaite lire en mettant le bit 3 a un (mask)
	uint8_t data[6];
